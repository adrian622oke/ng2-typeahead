System.register(["@angular/core", "@angular/common", "@angular/forms", "./PropertyHandler", "./autocomplete", "../src/html-outlet"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, forms_1, PropertyHandler_1, autocomplete_1, html_outlet_1, TypeAheadModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
